...
func main() {
	...
	// We can create a new template and parse its body from a string. Templates are a mix of static text
	// and “actions” enclosed in {{...}} that are used to dynamically insert content.
	t1 := template.New("t1")
