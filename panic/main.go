...
func main() {
	...
	// When first panic in main fires, the program exits without reaching the rest of the code. If you’d like to see
	// the program try to create a temp file, comment the first panic out.
