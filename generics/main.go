...
// MapKeys as an example of a generic function, takes a map of any type and returns a slice of its keys.
...
// List as an example of a generic type, is a singly-linked list with values of any type.
