...
func main() {
	...
	// This has the advantages of adding additional type-safety to our programs and eliminating
...
// PS: We’ve covered the basic of JSON in Go here, but check out the JSON and Go blog post and JSON package docs for more.
